...
class TransactionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return context.watch<UserDetailsProvider>().allTransactionList[index].method == 'walletTransfers'
                      ...
                      children: [
                        ...
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Icon(context.read<UserDetailsProvider>().allTransactionList[index].isCredit
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            context.watch<UserDetailsProvider>().allTransactionList[index].isCredit
                                ? Text(
                                    'Credit from ${context.watch<UserDetailsProvider>().allTransactionList[index].senderUsername}',
                                    style: Theme.of(context).textTheme.bodyMedium,
                                    softWrap: true,
                                    overflow: TextOverflow.ellipsis,
                                  )
                                : Text(
                                    'Transfer to ${context.watch<UserDetailsProvider>().allTransactionList[index].receiverUsername}',
                                    style: Theme.of(context).textTheme.bodyMedium,
                                    softWrap: true,
                                    overflow: TextOverflow.ellipsis),
                            ...
                            SizedBox(
                              ...
                              child: Text(
                                timeago
                                    .format(DateTime.fromMicrosecondsSinceEpoch(context
        ...
        : context.watch<UserDetailsProvider>().allTransactionList[index].method == 'airtime'
            ? Column(
      children: [
        SizedBox(
            height: SizeConfig.screenHeight * 0.05,
                    ...
                    children: [
                      ...
                      context.watch<UserDetailsProvider>().allTransactionList[index].isCredit
                        ...
                        overflow: TextOverflow.ellipsis,
                          ...
                          : Text(
                          'Loaded airtime to ${context.watch<UserDetailsProvider>().allTransactionList[index].receiverUsername}',
                          style: Theme.of(context).textTheme.bodyMedium,
                          softWrap: true,
                          overflow: TextOverflow.ellipsis),

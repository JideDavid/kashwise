...
import '../../Services/my_printer.dart';
...
class _SpendTabSectionState extends State<SpendTabSection> {
  ...
  void initState() {
    ...
    super.initState();
    getAllTransactionHistory(context);
  }
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.fromLTRB(
                TSizes.paddingSpaceXl, TSizes.paddingSpaceMd, TSizes.paddingSpaceXl, TSizes.paddingSpaceSm),
            child: Container(
              ...
              child: Padding(
                padding:
                    const EdgeInsets.symmetric(horizontal: TSizes.paddingSpaceLg * 2, vertical: TSizes.paddingSpaceLg),
                child: Column(
          ...
          //                           /// view more button
          //                           ? Padding(
          //                               padding: const EdgeInsets.fromLTRB(TSizes.paddingSpaceLg, TSizes.paddingSpaceSm,
          //                                   TSizes.paddingSpaceLg, TSizes.paddingSpaceLg),
          //                               child: FilledButton(
          //                                 onPressed: () {},
          //                                 style: Theme.of(context).filledButtonTheme.style!.copyWith(
          ...
          ///
          /// Empty list
          Provider.of<UserDetailsProvider>(context).allTransactionList.isEmpty
          ? Padding(
            padding: const EdgeInsets.symmetric(horizontal: TSizes.paddingSpaceXl),
            child: ClipRRect(
              borderRadius: BorderRadius.circular(10),
            ...
            child: ClipRRect(
              ...
              child: Container(
                ...
                child: RefreshIndicator(
                  onRefresh: () async{
                    context.read<UserDetailsProvider>().getAllTransactionHistory(context);
                  },
                  child: ListView.builder(
                    itemCount: context.watch<UserDetailsProvider>().allTransactionList.length > 5
                        ? 6
                          ...
                          ? index == 5
                              ...
                              ? Padding(
                                  ...
                                  child: FilledButton(
                                    ...
                                    style: Theme.of(context).filledButtonTheme.style!.copyWith(
                                        backgroundColor: const MaterialStatePropertyAll(TColors.primary),
                                        textStyle: const MaterialStatePropertyAll(TextStyle(color: TColors.white))),
                                    child: const Text(
                                      'View all',
                                      style: TextStyle(color: Colors.white),
                                    ),
